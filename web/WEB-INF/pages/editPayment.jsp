...
<script type="text/javascript">
    $(function () {
       $('#studentComboIdU').val('${payment.student.id}');
        $('#teacherComboIdU').val('${payment.teacher.id}');
        $('#lessonComboIdU').val('${payment.lesson.id}');
    });

</script>
<div class="lblDesign">Student :</div>
<select class="cmdDesign" id="studentComboIdU">
...
<select  class="cmdDesign" id="teacherComboIdU">
...
<select class="cmdDesign" id="lessonComboIdU">
    <br>
...
<input type="number" id="amountIdU" value="${payment.amount}">